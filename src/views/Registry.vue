<template>
  <div class="text-center p-4 md:py-4 md:px-8 bg-primary text-white">
    <div class="mt-12 p-2 md:p-8 md:max-w-5xl mx-auto">
      <h1 class="cormorant text-6xl mb-4">
        Registry
      </h1>
    </div>
  </div>
  <div class="text-center p-4 md:py-4 md:px-8">
    <div class="pt-12 p-2 md:p-8 md:max-w-5xl mx-auto">
      <p class="text-xl tracking-wide mb-1">
        We are registered at Target and Crate & Barrel.
      </p>
